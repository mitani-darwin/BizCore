module Permissions
  class Catalog
    ADMIN_RESOURCES = {
      ...
      purchase_orders: %i[read create update delete],
      purchase_receipts: %i[read create update delete],
      purchase_adjustments: %i[read create update delete],
      purchase_bill_batches: %i[read create update delete],
      purchase_bills: %i[read create update delete],
      supplier_payments: %i[read create update delete],
      quotations: %i[read create update delete],
      orders: %i[read create update delete],
      deliveries: %i[read create update delete],
      billing_batches: %i[read create update delete],
      invoices: %i[read create update delete],
